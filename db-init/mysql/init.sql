...
-- ----------------------------
-- Table structure for campus_credential_consent
-- ----------------------------
DROP TABLE IF EXISTS `campus_credential_consent`;
CREATE TABLE `campus_credential_consent` (
...
-- ----------------------------
-- Records of campus_credential_consent
-- ----------------------------
BEGIN;
COMMIT;
