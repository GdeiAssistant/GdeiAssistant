    ...
    <div class="max-w-2xl mx-auto px-4 py-6">
      ...
      <section class="mt-4 bg-[var(--color-surface)] rounded-xl p-4 shadow-sm">
        <div class="text-sm leading-relaxed text-[var(--c-text-2)] [&_p]:my-3 [&_img]:max-w-full [&_img]:h-auto [&_img]:my-4">
          ...
          <p class="indent-8">广东第二师范学院的同学们，欢迎使用广东第二师范学院校园助手系统。<span class="account-inline-emphasis">若你为新生或首次使用本系统，建议你先阅读本使用说明</span>。</p>
          <p class="indent-8">使用本系统，需要使用校园网账号的用户名与密码进行登录。<span class="account-inline-emphasis">值得注意的是，用户名并不是学号</span>。此外，<span class="account-inline-emphasis">新生一般需要一周的时间等待网络中心激活学院应用信息系统账号，若你无法登录系统，建议暂时耐心等待</span>。</p>
          ...
          <p class="text-left indent-8">若姓名、学工号、身份证号和验证码信息正确无误，页面将显示你的校园网账号信息。其中，<span class="account-inline-emphasis">用户名则是使用本系统需要填写的账号用户名，2015级后的学生初始密码为身份证后六位数字。由于使用初始密码存在风险，建议你及时修改账号密码。</span></p>
        </div>
      </section>
      </div>
