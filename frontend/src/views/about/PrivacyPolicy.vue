    ...
    <div class="max-w-3xl mx-auto px-4 py-6">
      <div class="rounded-xl bg-[var(--c-surface)] border border-[var(--c-border)] p-5 md:p-6">
        <div
          ...
          <p><strong>2.5 用户选择权。</strong> 您可以拒绝保存校园凭证，但相应快速认证、会话同步或部分校园查询功能可能不可用。若当前没有完整自助入口，您可通过账号设置、反馈渠道、站内工单或平台后续提供的入口申请处理。</p>
          ...
          <p><strong>7.2</strong> 当前已提供或可能逐步提供的路径通常包括账号设置、隐私设置、反馈渠道、站内工单、帮助与反馈页面或后续上线的自助入口。若当前没有完整自助功能，您仍可通过人工渠道提交申请。</p>
          ...
          <h3>第十一条 联系与反馈</h3>
          <p><strong>11.1</strong> 如您对本政策、个人信息处理、校园凭证、账号安全、投诉举报或删除申请有疑问，可优先通过应用内“帮助与反馈”、站内工单、仓库公开反馈渠道或后续公布的专门入口联系平台。</p>
