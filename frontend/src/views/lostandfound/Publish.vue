  ...
  <div class="min-h-screen bg-[var(--c-bg)]">
    ...
    <div class="p-0">
      ...
      <div class="relative pl-[90px] text-base min-h-[70px] border-b border-[var(--c-border)] bg-[var(--c-surface)] mx-2.5">
        ...
        <div class="pt-[18px]">
          <input type="text" :placeholder="t('lostandfound.publish.placeholder.title')" v-model="formData.title" maxlength="25" class="text-[var(--c-text-1)] bg-transparent h-[34px] leading-[34px] text-base w-full border-none outline-none" />
        </div>
      </div>
      ...
      <!-- Contact tip -->
      <div class="mt-5 text-center text-[#f6383a] text-sm py-2.5">{{ t('lostandfound.publish.contactTip') }}</div>
    ...
    <div v-if="itemTypePickerVisible">
      ...
      <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--c-surface)] rounded-xl w-[280px] max-w-[320px] z-[1001] shadow-lg overflow-hidden">
        <div class="text-center font-semibold text-base text-[var(--c-text-1)] pt-5 pb-2">{{ t('lostandfound.publish.itemTypePickerTitle') }}</div>
