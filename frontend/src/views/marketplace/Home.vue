...
<template>
  <div class="bg-[var(--c-bg)] min-h-screen pb-5">
    ...
    <!-- 分类宫格 -->
    <div class="grid! grid-cols-4 w-[calc(100%-20px)] mx-2.5 mb-4 marketplace-category-grid bg-[var(--c-surface)] rounded-lg overflow-hidden shadow-sm">
      <div
      ...
      >
        <component :is="cat.icon" class="w-[22px] h-[22px] mb-1.5 shrink-0 marketplace-action-icon" :stroke-width="1.5" />
