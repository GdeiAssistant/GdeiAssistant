...
public interface LostAndFoundMapper {
    ...
    public LostAndFoundInfo selectInfoByID(Integer id);
    ...
    public List<LostAndFoundItem> selectItemByUsername(String username);
    ...
    public void insertItem(LostAndFoundItem lostAndFoundItem);
    ...
    public void updateItemItem(LostAndFoundItem lostAndFoundItem);

    @Update("update lostandfound set state=#{state} where id=#{id}")
    public void updateItemState(@Param("id") Integer id, @Param("state") Integer state);
}
