...
public class UserProfileService {
    ...
    public void UpdateAvatar(String sessionId, InputStream inputStream) {
        User user = userCertificateService.GetUserLoginCertificate(sessionId);
        aliyunOssUtils.UploadOSSObject("gdeiassistant-userdata", "avatar/"
    ...
    public void DeleteAvatar(String sessionId) {
        User user = userCertificateService.GetUserLoginCertificate(sessionId);
        aliyunOssUtils.DeleteOSSObject("gdeiassistant-userdata", "avatar/" + user.getUsername() + ".jpg");
        aliyunOssUtils.DeleteOSSObject("gdeiassistant-userdata", "avatar/" + user.getUsername() + "_hd.jpg");
    }
