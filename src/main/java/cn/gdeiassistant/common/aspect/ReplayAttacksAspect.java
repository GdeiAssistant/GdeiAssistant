...
import cn.gdeiassistant.common.exception.RequestValidException.NonceInvalidException;
import cn.gdeiassistant.common.exception.RequestValidException.SignInvalidException;
import cn.gdeiassistant.common.exception.RequestValidException.TimestampInvalidException;
import cn.gdeiassistant.common.pojo.Config.ReplayAttacksValidateConfig;
import cn.gdeiassistant.common.pojo.Entity.RequestValidation;
import cn.gdeiassistant.common.redis.Request.RequestDao;
import cn.gdeiassistant.common.tools.Utils.SpringProfileUtils;
...
public class ReplayAttacksAspect {
    ...
    @Pointcut("@annotation(cn.gdeiassistant.common.annotation.ReplayAttacksProtection)")
