package cn.gdeiassistant.common.db;
...
public class DataSQLBuilder {
    ...
    public String selectUserDeliveryOrderList(String username) {
        return new SQL() {{
            SELECT("do.order_id,do.username,do.order_time,do.name,do.number,do.phone,do.price,do.company");
    ...
    public String selectUserDeliveryTradeList(String username) {
        return new SQL() {{
            SELECT("dt.trade_id,dt.order_id,dt.create_time,dt.username,dt.state");
