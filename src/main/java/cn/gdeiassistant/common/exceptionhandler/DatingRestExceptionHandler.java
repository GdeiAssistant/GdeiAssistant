...
import cn.gdeiassistant.core.roommate.controller.RoommateController;
...
@RestControllerAdvice(basePackageClasses = { DeliveryController.class, RoommateController.class })
@Order(value = 0)
