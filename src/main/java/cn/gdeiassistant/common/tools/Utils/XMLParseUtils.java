...
import cn.gdeiassistant.core.wechat.pojo.WechatArticle;
import cn.gdeiassistant.core.wechat.pojo.WechatImageTextMessage;
...
public class XMLParseUtils {
    ...
    public static List<RSSNewInfo> parseRssNewsXml(String xml) {
        ...
        try {
            ...
            logger.error("解析 RSS 新闻 XML 失败", e);
        }
        return list;
    }
