package cn.gdeiassistant.core.express.pojo.entity;
...
/**
 * 表白表持久化实体，仅用于 MyBatis 映射与 Service 内部。
 * 表名、列名不变；column 已通过 @Result 映射为驼峰 property。
 */
public class ExpressEntity implements Serializable, Entity {
