...
public interface PhotographMapper {
    ...
    List<PhotographEntity> selectPhotograph(@Param("start") int start, @Param("size") int size
    ...
    @Select("select p.id,p.title,p.content,p.count,p.type,p.username,p.create_time," +
            ...
            " left join photograph_like pl on p.id=pl.photo_id" +
            " left join photograph_comment pc on p.id=pc.photo_id" +
            " where p.username=#{username} group by p.id order by p.id desc limit #{start},#{size}")
    @ResultMap("Photograph")
    List<PhotographEntity> selectPhotographByUsername(@Param("start") int start, @Param("size") int size, @Param("username") String username);
    ...
    List<PhotographEntity> selectPhotographByIdAndUsername(@Param("id") int id, @Param("username") String username);
    ...
    void insertPhotograph(PhotographEntity photograph);
    ...
    List<PhotographCommentEntity> selectPhotographCommentByPhotoId(int id);
