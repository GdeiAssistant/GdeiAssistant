...
import com.gdeiassistant.gdeiassistant.Exception.RequestValidException.NonceInvalidException;
import com.gdeiassistant.gdeiassistant.Exception.RequestValidException.SignInvalidException;
import com.gdeiassistant.gdeiassistant.Exception.RequestValidException.TimestampInvalidException;
import com.gdeiassistant.gdeiassistant.Repository.Redis.Request.RequestDao;
...
public class ReplayAttacksAspect {
    ...
    @Pointcut("@annotation(com.gdeiassistant.gdeiassistant.Annotation.ReplayAttacksProtection)")
