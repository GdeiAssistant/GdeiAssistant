...
<p class="page_desc" style="margin-top: 15px">无法自助注销？点击
    <a class="page_desc"
       onclick="window.location.href = 'mailto:support@gdeiassistant.cn?subject=注销账号&body=请尽可能补全此模板邮件中的空缺信息，并通过附件上传身份证/学生证/教师工作证/教务系统个人信息界面截图（截图需包含显示操作系统当前时间，' +
               ...
               '你提供的信息将被严格保密，并在完成账号注销后的48小时内进行删除。%0d%0a用户名：${sessionScope.username}%0d%0a注销原因：%0d%0a注册时间：（具体到月份，如2016年6月）%0d%0a注册地点：（具体到城市，如广东省广州市）%0d%0a常用设备型号：（如填写iPhoneXR/魅蓝E3）'">联系客服进行注销
    </a>
</p>
