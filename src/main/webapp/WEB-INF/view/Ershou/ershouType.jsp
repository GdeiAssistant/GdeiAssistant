...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadErshouInfo(start) {
            $.ajax({
                url: '/api/ershou/item/type/' + $("#type_number").val() + "/start/" + start,
                type: 'get',
...
<input type="hidden" id="type_number" name="type_number" value="${TypeNumber}"/>
...
<section class="search">
    ...
    <i class="txt">
        <form onkeydown="if(event.keyCode===13){keywordSearch();return false;}">
            <input id="keyword_input" type="text" name="keyword" value="" placeholder="${TypeName}">
