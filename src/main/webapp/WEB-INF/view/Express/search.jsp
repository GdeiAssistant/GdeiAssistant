...
<head>
    ...
    <script>document.write("<script type='text/javascript' src='/js/express/search.js?time=" + Date.now() + "'><\/script>");</script>
...
<!-- 网页主体 -->
<div class="main-body ui-content" id="search-bars" data-role="content">

    <!-- 搜索按钮 -->
    <div class="ui-field-contain">
        <label for="search-bars-input">搜索：</label>
        <input type="search" name="search" maxlength="10" id="search-bars-input" placeholder="请输入关键词">
    </div>
    <input id="search-bars-submit" style="text-align:center;display:block;margin:0 auto;" type="submit"
           data-inline="true" value="搜索" onclick="searchKeyword()">
...
<!-- 加载更多 -->
<section style="display: none" id="loadmore" class="loadmore" onclick="loadExpress()">
    <span>点击加载更多</span>
</section>
...
<div data-role="footer" id="footer" data-position="fixed" data-fullscreen="true" data-tap-toggle="false">
    <div class="ui-navbar" data-role="navbar" role="navigation">
        <ul>
            ...
            <li><a href="/express/search" data-ajax='false' data-role="button" data-icon="searchNow"
