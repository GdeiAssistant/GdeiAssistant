...
<head>
    ...
    <script>document.write("<script type='text/javascript' src='/js/topic/index.js?time=" + Date.now() + "'><\/script>");</script>
</head>
<body>
...
<div class="weui-tab">
    ...
    <div class="weui-tab__panel">
        ...
        <div class="weui-cells__title" onclick="window.location.href='/index'">返回</div>
        ...
        <p id="loadmore" style="text-align: center; font-size: 14px; color: #777;margin-top: 15px;margin-bottom: 35px"
    ...
    <div class="weui-tabbar">
        <a href="javascript:" onclick="window.location.href='/topic'" class="weui-tabbar__item weui-bar__item_on">
