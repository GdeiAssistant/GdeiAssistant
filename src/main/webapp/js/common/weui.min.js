...
!function (e, t) {
    ...
    return function (e) {
        ...
        var a = n(1), o = i(a), r = n(7), u = i(r), l = n(8), s = i(l), d = n(9), f = i(d), c = n(11), p = i(c),
            h = n(13), v = i(h), m = n(15), w = i(m), _ = n(17), g = i(_), y = n(18), b = i(y), k = n(19), x = i(k),
            ...
            l.onload = function (l) {
                ...
                s.onload = function () {
                    var l = n(s), d = o(i(s.src)), f = document.createElement("canvas"), c = f.getContext("2d"),
                        p = t.compress.width, h = t.compress.height, v = s.width, m = s.height, w = void 0;
        ...
        function n(e) {
            var t = e.url, n = e.file, i = e.fileVal, a = e.onBeforeSend, o = e.onProgress, r = e.onError,
                u = e.onSuccess, l = n.name, s = n.type, d = n.lastModifiedDate,
                f = {name: l, type: s, size: "file" == e.type ? n.size : n.base64.length, lastModifiedDate: d}, c = {};
            if (a(n, f, c) !== !1) {
        ...
        o.default.fn.scroll = function (e) {
            ...
            function i(e) {
                if (m) {
                    ...
                    if (w = e, t - _ > 100) M(Math.abs(w - m) > 10 ? w - m : n - w); else if (Math.abs(w - m) > 10) {
                        ...
                        if (a !== i) {
                            var r = y[i], u = y[a], l = r.time - u.time, s = r.y - u.y, d = s / l,
                                f = 150 * d + (w - m);
                            M(f)
                        } else M(0)
                    } else M(n - w);
            ...
            var v = h.find(c.scrollable), m = void 0, w = void 0, _ = void 0, g = void 0, y = [],
